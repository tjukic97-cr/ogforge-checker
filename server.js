...
<h2>Contact</h2>
<p>Questions or requests about your data: <a href="mailto:hello@unfurl.pro">hello@unfurl.pro</a></p>
...
function doUnsub(){
  ...
  fetch('/api/unsubscribe',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({email:e})})
    ...
    .then(function(res){
      ...
      else{err.textContent='⚠ Something went wrong. Please try again, or email hello@unfurl.pro.';err.style.display='block';}
    })
    .catch(function(){err.textContent='⚠ Something went wrong. Please try again.';err.style.display='block';});
}
</script>
