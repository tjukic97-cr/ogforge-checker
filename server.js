...
<section id="pricing">
  <div class="wrap">
    ...
    <p class="sec-sub">The checker is free forever. Pay only when you want Unfurl generating and syncing for you.</p>
    <div class="prices">
      <div class="price">
...
<footer>
  <div class="wrap">
    ...
    <span class="muted">© 2026 Unfurl · made for developers</span>
  </div>
</footer>
...
function startMonitor(){
  ...
  fetch('/api/signup',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({kind:'monitor',email:e,url:url})})
    ...
    .then(function(res){
      ...
      else{document.getElementById('monitorEmail').style.borderColor='#FF5F57';}
    })
    .catch(function(){document.getElementById('monitorEmail').style.borderColor='#FF5F57';});
}
function joinWaitlist(){
  ...
  fetch('/api/signup',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({kind:'waitlist',email:e})})
    ...
    .then(function(res){
      ...
      else{document.getElementById('email').style.borderColor='#FF5F57';}
    })
    .catch(function(){document.getElementById('email').style.borderColor='#FF5F57';});
}
