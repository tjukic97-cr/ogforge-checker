...
// Sends the "your link broke" email. STAGE 1: stub that logs only.
// STAGE 2 will wire this to Resend.
async function sendBreakAlert(row, report) {
  console.log(`[ALERT] would email ${row.email} — ${row.url} dropped to ${report.grade} (${report.score})`);
  return true;
}
